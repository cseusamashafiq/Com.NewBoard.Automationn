...
public class TC_04 extends LambdaTestDriver{
	...
	@Test(groups = {"Login Testing with Invalid OTP", "CompleteRegressionSuite"})
	public void newBoardLogin() throws Exception {
		...
		ltOptions.put("build", "TC_04_Login_Invalid_OTP");
		ltOptions.put("project", "TC_04_Login_Invalid_OTP");
		ltOptions.put("name", "TC_04_Login_Invalid_OTP");
